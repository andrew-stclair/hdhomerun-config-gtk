...
static void on_device_selected(HDHomeRunWindow *self, uint32_t device_id, uint32_t tuner_count)
{
  g_message("Window: Signal received! Device %08X, Tuners %u", device_id, tuner_count);
